...
def plot_learning_curve(estimator, title, X, y, axes = None, ylim=None, cv=None, n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5)):
    ...
    axes[1].set_title("NeuralNetworks model Performance using Simulated Annealing")
...
plot_learning_curve(mlrose.NeuralNetwork(hidden_nodes = [2], activation = 'identity', \
algorithm = 'simulated_annealing', max_iters = 1000, \
bias = True, is_classifier = True, learning_rate = 0.1, \
early_stopping = True, clip_max = 5, max_attempts = 100, \
random_state = 3),"Learning Curve for Neural networks using Simulated Annealing", X, y)
...
classifier = mlrose.NeuralNetwork(hidden_nodes = [2], activation = 'identity', \
algorithm = 'simulated_annealing', max_iters = 1000, \
bias = True, is_classifier = True, learning_rate = 0.1, \
early_stopping = True, clip_max = 5, max_attempts = 100, \
random_state = 3)
